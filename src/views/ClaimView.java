...
public class ClaimView {
    // Method to display the details of a claim
    public static void displayClaimDetails(Claim claim) {
        System.out.println("-------------------------------------------------------------");
        System.out.println("Claim Details:");
        System.out.println("Claim ID: " + claim.getClaimID());
        System.out.println("Claim Date (mm/dd/yyyy): " + claim.getFormattedClaimDate());
        System.out.println("Insured Person: " + claim.getInsuredPerson());
        System.out.println("Card Number: " + claim.getCardNum());
        System.out.println("Exam Date (mm/dd/yyyy): " + claim.getFormattedExamDate());
